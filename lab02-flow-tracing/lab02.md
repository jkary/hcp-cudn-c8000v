...
Traffic flows through the c8000v on `lab-network`. The capture pods are identical to lab01 test pods but with `NET_RAW` capability added, allowing tshark/tcpdump to capture on the CUDN interface.
